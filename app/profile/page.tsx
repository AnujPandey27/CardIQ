...
export default function ProfilePage() {
  ...
  const handleSaveChanges = async () => {
    ...
    setName(trimmedName);
    setSaveMessage(
      "Profile settings have been saved."
    );
    setSaving(false);
  };
      ...
      <div className="mx-auto max-w-4xl px-5 py-8 lg:px-8 lg:py-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-[var(--muted)]">
                This name is used in the CardIQ profile switcher.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-[var(--muted)]">
                Country is controlled by the regional profile and cannot be edited here.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-[var(--muted)]">
                Currency is tied to this regional profile.
              </p>
            </div>
        ...
        <section className="mb-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm sm:p-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-[var(--muted)]">
              These preferences will apply to the active regional profile.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-[var(--muted)]">
              Custom reward valuation storage will be added when reward preferences are connected to the profile settings data model.
            </p>
          </div>
        </section>
